...
# UI staet for the ROI rectangle is (x1,y1) -> (x2,y2)
x1 = y1 = 0
x2 = y2 = 0
...
LINE_GRAB_PX = 10   # how close the mouse must be to grab one of the line
MIN_ROI_SIZE = 30   # minimum size
...
def on_mouse(event, mx, my, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if changed:
            ...
            roi_moved = True  # mark that roi has moved
...
print("Option A crop: detection/compare/save uses ONLY the ROI crop (outside ignored).")
